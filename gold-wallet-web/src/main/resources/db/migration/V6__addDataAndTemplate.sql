...
-- Buy/Sell operations
INSERT INTO template (created_by, created_at, name, value)
VALUES ('System', now(), 'BUY_WITHDRAWAL', 'برداشت ${amount} ریال برای خرید از ${merchant} - شناسه: ${traceId}')
    ON CONFLICT DO NOTHING;

INSERT INTO template (created_by, created_at, name, value)
VALUES ('System', now(), 'BUY_DEPOSIT', 'واریز ${amount} گرم از ${merchant} - شناسه: ${traceId}')
    ON CONFLICT DO NOTHING;

INSERT INTO template (created_by, created_at, name, value)
VALUES ('System', now(), 'SELL_WITHDRAWAL', 'برداشت ${amount} گرم برای فروش به ${merchant} - شناسه: ${traceId}')
    ON CONFLICT DO NOTHING;

INSERT INTO template (created_by, created_at, name, value)
VALUES ('System', now(), 'SELL_DEPOSIT', 'واریز ${price} ریال از فروش به ${merchant} - شناسه: ${traceId}')
    ON CONFLICT DO NOTHING;
