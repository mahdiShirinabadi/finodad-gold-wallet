...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_wallet_national_code_wallet_type_end_time
    ON wallet(national_code, wallet_type_id, end_time)
    WHERE end_time IS NULL;

-- Index for wallet created_at (for date range queries and sorting)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_wallet_created_at
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_wallet_account_wallet_entity
    ON wallet_account(wallet_id);

-- Index for wallet account lookup by account number (unique constraint)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_wallet_account_account_number
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_request_id
    ON request(id);

-- Index for request aggregation queries (most critical for reporting)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_request_aggregation
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_cash_in_ref_number
    ON cash_in_request(ref_number);

-- Index for cash in request aggregation queries
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_cash_in_wallet_account_request
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_cash_out_wallet_account_request
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_purchase_wallet_account_request_type
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_physical_cash_out_wallet_account_request
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_rrn_uuid
    ON rrn(uuid);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_channel_role_channel_role
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_role_resource_role
