...
public interface GiftCardOperationService {
	...
	GiftCardResponse process(GiftCardProcessObjectDTO giftCardProcessObjectDTO) throws InternalServiceException;
	void payment(GiftCardPaymentObjectDTO giftCardPaymentObjectDTO) throws InternalServiceException;
