...
public interface StatusRepositoryService {
    ...
    int SELL_EXCEEDED_AMOUNT_MONTHLY_LIMITATION = 60;
    int SELL_EXCEEDED_COUNT_MONTHLY_LIMITATION = 61;
    int SELL_EXCEEDED_AMOUNT_DAILY_LIMITATION = 62;
    int SELL_EXCEEDED_COUNT_DAILY_LIMITATION = 63;
