...
public class WalletSellLimitationOperationServiceImplementation implements WalletSellLimitationOperationService {

    private final WalletSellLimitationRepositoryService walletSellLimitationRepositoryService;
    ...
    public void checkGeneral(ChannelEntity channel, WalletEntity wallet, BigDecimal quantity, WalletAccountEntity walletAccount, String uniqueIdentifier) throws InternalServiceException {
        ...
        BigDecimal minQuantity = new BigDecimal(limitationGeneralCustomRepositoryService.getSetting(channel, LimitationGeneralService.MIN_QUANTITY_SELL, walletLevelEntity, walletAccountTypeEntity, walletAccountCurrencyEntity, walletTypeEntity));
        BigDecimal maxQuantity = new BigDecimal(limitationGeneralCustomRepositoryService.getSetting(channel, LimitationGeneralService.MAX_QUANTITY_SELL, walletLevelEntity, walletAccountTypeEntity, walletAccountCurrencyEntity, walletTypeEntity));
        ...
        redisLockService.runAfterLock(key, this.getClass(), () -> {
            ...
            if (quantity.compareTo(maxQuantity) > 0) {
                ...
                throw new InternalServiceException("sell amount is bigger than maxSell", StatusRepositoryService.QUANTITY_BIGGER_THAN_MAX, HttpStatus.OK, Map.ofEntries(
            ...
            if (quantity.compareTo(minQuantity)< 0) {
                ...
                throw new InternalServiceException("sell amount is less than minSell", StatusRepositoryService.QUANTITY_LESS_THAN_MIN, HttpStatus.OK, Map.ofEntries(
                        entry("1", Utility.addComma(quantity.longValue())),
    ...
    public void checkDailyLimitation(ChannelEntity channel, WalletEntity wallet, BigDecimal quantity, WalletAccountEntity walletAccount, String uniqueIdentifier) throws InternalServiceException {
        ...
        BigDecimal maxQuantityDaily = new BigDecimal(limitationGeneralCustomRepositoryService.getSetting(channel, LimitationGeneralService.MAX_DAILY_QUANTITY_SELL, walletLevelEntity, walletAccountTypeEntity, walletAccountCurrencyEntity, walletTypeEntity));
        BigDecimal maxCountDaily = new BigDecimal(limitationGeneralCustomRepositoryService.getSetting(channel, LimitationGeneralService.MAX_DAILY_COUNT_SELL, walletLevelEntity, walletAccountTypeEntity, walletAccountCurrencyEntity, walletTypeEntity));
        ...
        redisLockService.runAfterLock(key, this.getClass(), () -> {
            ...
            WalletDailySellLimitationRedis walletDailySellLimitationRedis = walletSellLimitationRepositoryService.findDailyById(walletLimitationId);
            if (walletDailySellLimitationRedis == null) {
                ...
                AggregationPurchaseDTO aggregationPurchaseDTO = requestRepositoryService.findSumAmountByTransactionTypeBetweenDate(new long[]{walletAccount.getId()}, TransactionTypeEnum.SELL.name(), new Date(), new Date());
                ...
                walletSellLimitationRepositoryService.saveDaily(walletDailySellLimitationRedis);
            }
    ...
    public void checkMonthlyLimitation(ChannelEntity channel, WalletEntity wallet, BigDecimal amount, WalletAccountEntity walletAccount, String uniqueIdentifier) throws InternalServiceException {
        ...
        boolean checkMonthly = Boolean.parseBoolean(limitationGeneralCustomRepositoryService.getSetting(channel, LimitationGeneralService.MONTHLY_VALIDATION_CHECK_SELL, walletLevelEntity, walletAccountTypeEntity, walletAccountCurrencyEntity, walletTypeEntity));
        BigDecimal maxCountMonthly = new BigDecimal(limitationGeneralCustomRepositoryService.getSetting(channel, LimitationGeneralService.MAX_MONTHLY_COUNT_SELL, walletLevelEntity, walletAccountTypeEntity, walletAccountCurrencyEntity, walletTypeEntity));
        BigDecimal maxQuantityMonthly = new BigDecimal(limitationGeneralCustomRepositoryService.getSetting(channel, LimitationGeneralService.MAX_MONTHLY_QUANTITY_SELL, walletLevelEntity, walletAccountTypeEntity, walletAccountCurrencyEntity, walletTypeEntity));
        ...
        redisLockService.runAfterLock(key, this.getClass(), () -> {
            ...
            WalletMonthlySellLimitationRedis walletMonthlySellLimitationRedis = walletSellLimitationRepositoryService.findMonthlyById(walletLimitationId);
            if (walletMonthlySellLimitationRedis == null) {
                ...
                AggregationPurchaseDTO aggregationPurchaseDTO = requestRepositoryService.findSumAmountByTransactionTypeBetweenDate(new long[]{walletAccount.getId()}, TransactionTypeEnum.SELL.name(), fromDate, untilDate);
                ...
                walletSellLimitationRepositoryService.saveMonthly(walletMonthlySellLimitationRedis);
            }
            ...
            if (walletMonthlySellLimitationRedis.getQuantity().add(amount).compareTo(maxQuantityMonthly)> 0) {
                ...
                throw new InternalServiceException("wallet sum amount sell exceeded the limitation !!!", StatusRepositoryService.SELL_EXCEEDED_AMOUNT_MONTHLY_LIMITATION, HttpStatus.OK, Map.ofEntries(
            ...
            if ((walletMonthlySellLimitationRedis.getCount() + 1) > maxCountMonthly.longValue()) {
                ...
                throw new InternalServiceException("wallet count sell exceeded the limitation !!!", StatusRepositoryService.SELL_EXCEEDED_COUNT_MONTHLY_LIMITATION, HttpStatus.OK, Map.ofEntries(
                        entry("1", Utility.addComma(walletMonthlySellLimitationRedis.getAmount() + amount.longValue())),
    ...
    public void deleteAll() {
        walletSellLimitationRepositoryService.deleteAll();
    }
