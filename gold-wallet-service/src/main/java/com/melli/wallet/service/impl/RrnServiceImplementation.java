...
public class RrnServiceImplementation implements RrnService {
    ...
    public RrnEntity findByUid(String uuid) throws InternalServiceException {
        ...
        if(rrn == null){
            ...
            throw new InternalServiceException("rrn not exist in table !!! ", StatusService.UUID_NOT_FOUND, HttpStatus.OK);
        }
        return rrn;
    }
    ...
    public RrnEntity checkRrn(String uuid, ChannelEntity channelEntity, RequestTypeEntity requestTypeEntity, String amount, String accountNumber) throws InternalServiceException {
        ...
        if(rrn.getChannel().getId() != channelEntity.getId()){
            ...
            throw new InternalServiceException(errorMessage, StatusService.UUID_NOT_FOUND, HttpStatus.OK);
        }
        ...
        if(StringUtils.hasText(accountNumber)){
            ...
            if(!accountNumber.equals(storedAccountNumber)){
                ...
                log.error(errorMessage);
                throw new InternalServiceException(errorMessage, StatusService.ACCOUNT_NUMBER_NOT_SAME_WITH_UUID, HttpStatus.OK);
            }
        }
