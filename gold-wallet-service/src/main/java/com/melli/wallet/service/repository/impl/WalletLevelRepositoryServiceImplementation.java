...
public class WalletLevelRepositoryServiceImplementation implements WalletLevelRepositoryService {
    ...
    public WalletLevelEntity getById(Long id) throws InternalServiceException {
        ...
        if (reportEntity == null) {
            ...
            throw new InternalServiceException("Wallet level not found", StatusRepositoryService.WALLET_LEVEL_NOT_FOUND, HttpStatus.OK);
        }
    ...
    public WalletLevelEntity getByIdManaged(Long id) throws InternalServiceException {
        return walletLevelRepository.findById(id).orElseThrow(() -> {
            log.error("wallet level with id ({}) not found", id);
            return new InternalServiceException("Wallet level not found", StatusRepositoryService.WALLET_LEVEL_NOT_FOUND, HttpStatus.OK);
        });
    }
