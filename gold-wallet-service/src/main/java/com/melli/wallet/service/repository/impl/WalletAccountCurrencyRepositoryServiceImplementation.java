...
public class WalletAccountCurrencyRepositoryServiceImplementation implements WalletAccountCurrencyRepositoryService {
    ...
    public WalletAccountCurrencyEntity findCurrency(String currency) throws InternalServiceException {
        return walletAccountCurrencyRepository.findByNameIgnoreCase(currency).orElseThrow(() -> {
            ...
            return new InternalServiceException("Currency not supported", StatusRepositoryService.WALLET_ACCOUNT_CURRENCY_NOT_FOUND, HttpStatus.OK);
        });
    }
    ...
    public WalletAccountCurrencyEntity getById(Long id) throws InternalServiceException {
        return walletAccountCurrencyRepository.findById(id).orElseThrow(() -> {
            ...
            return new InternalServiceException("Wallet account currency not found",  StatusRepositoryService.WALLET_ACCOUNT_CURRENCY_NOT_FOUND, HttpStatus.OK);
        });
    }
}
