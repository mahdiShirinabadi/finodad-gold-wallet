...
public interface LimitationGeneralService {
    ...
    String MIN_AMOUNT_PHYSICAL_CASH_OUT = "MIN_AMOUNT_PHYSICAL_CASH_OUT";
    String MAX_AMOUNT_PHYSICAL_CASH_OUT = "MAX_AMOUNT_PHYSICAL_CASH_OUT";
    String MAX_WALLET_AMOUNT_DAILY_PHYSICAL_CASH_OUT = "MAX_WALLET_AMOUNT_DAILY_PHYSICAL_CASH_OUT";
