...
public class SubHelper {
    ...
    public SubHelper(RequestTypeRepositoryService requestTypeRepositoryService) {
        this.requestTypeRepositoryService = requestTypeRepositoryService;
    }

    public WalletAccountTypeObject convertWalletAccountEntityToObject(WalletAccountTypeEntity entity){
    ...
    public WalletAccountCurrencyObject convertWalletAccountCurrencyEntityToObject(WalletAccountCurrencyEntity entity){
    ...
    public CollateralCreateTrackObject convertToCreateCollateralTrackResponse(CreateCollateralRequestEntity createCollateralRequestEntity, StatusRepositoryService statusRepositoryService){
    ...
    public CollateralReleaseTrackObject convertToCollateralRelease(ReleaseCollateralRequestEntity releaseCollateralRequestEntity, StatusRepositoryService statusRepositoryService) {
    ...
    public CollateralIncreaseTrackObject convertToCollateralIncrease(IncreaseCollateralRequestEntity increaseCollateralRequestEntity, StatusRepositoryService statusRepositoryService) {
    ...
    public PanelChannelObject fillPanelChannelObject(ReportChannelEntity channelEntity) {
    ...
    public MerchantObject convertMerchantEntityToMerchantObject(MerchantEntity merchantEntity) {
    ...
    public CollateralObject convertCollateralEntityToCollateralObject(CollateralEntity collateralEntity) {
    ...
    public String prettyBalance(BigDecimal num){
        DecimalFormat df = new DecimalFormat("0.#####");
        return df.format(num);
    }

    public ChannelObject convertChannelEntityToChannelObject(ChannelEntity channelEntity) {
    ...
    public PanelRoleObject fillChannelRoleListObject(ReportChannelRoleEntity channelRoleEntity) {
    ...
    public PanelResourceObject fillPanelResourceListObject(ReportResourceEntity resourceEntity) {
