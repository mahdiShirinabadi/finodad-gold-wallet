...
@RedisHash(value = ConstantRedisName.WALLET_PHYSICAL_CASH_OUT_LIMITATION, timeToLive = 86400L) // 1 day
@Setter
@Getter
public class WalletPhysicalCashOutLimitationRedis implements Serializable {
