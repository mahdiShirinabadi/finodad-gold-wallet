...
/**
 * Class Name: ReportProfileEntity
...
@NoArgsConstructor
@Table(name = "channel")
public class ReportChannelEntity extends ReportBaseEntityAudit implements Serializable, UserDetails {
    ...
    private List<ReportChannelRoleEntity> channelRoleList = new ArrayList<>();
