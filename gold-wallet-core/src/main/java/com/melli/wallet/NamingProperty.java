...
public class NamingProperty {
    ...
    public static final String LIMITATION_OBJECT_LIST = "limitationObjectList";
    ...
    public static final String WALLET_ACCOUNT_OBJECT_LIST = "walletAccountObjectList";
    public static final String SUFFIX = "suffix";
    public static final String WALLET_ACCOUNT_TYPE_OBJECT = "walletAccountTypeObject";
